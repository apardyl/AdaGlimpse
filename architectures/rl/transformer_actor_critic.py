...
class TransformerActorCritic(nn.Module):
    def __init__(self, action_dim=3, norm_layer=partial(nn.LayerNorm, eps=1e-6), embed_dim=768, num_heads=12,
                 mlp_ratio=4, depth=2):
        super().__init__()
        ...
        class ActorNet(nn.Module):
            def __init__(self):
                ...
                self.blocks = nn.ModuleList([
                    Layer_scale_init_Block(embed_dim, num_heads, mlp_ratio, qkv_bias=True, qk_scale=None,
